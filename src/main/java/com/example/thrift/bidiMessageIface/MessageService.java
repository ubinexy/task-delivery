...
public class MessageService {
  ...
  public interface Iface {
    ...
    public void messageCallback(String name, int status) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void messageCallback(String name, int status, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void messageCallback(String name, int status) throws org.apache.thrift.TException
    {
      send_messageCallback(name, status);
    }

    public void send_messageCallback(String name, int status) throws org.apache.thrift.TException
    {
      messageCallback_args args = new messageCallback_args();
      args.setName(name);
      args.setStatus(status);
      sendBaseOneway("messageCallback", args);
    }
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void messageCallback(String name, int status, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      messageCallback_call method_call = new messageCallback_call(name, status, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class messageCallback_call extends org.apache.thrift.async.TAsyncMethodCall<Void> {
      private String name;
      private int status;
      public messageCallback_call(String name, int status, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, true);
        this.name = name;
        this.status = status;
      }
      ...
      public void write_args(org.apache.thrift.protocol.TProtocol prot) throws org.apache.thrift.TException {
        prot.writeMessageBegin(new org.apache.thrift.protocol.TMessage("messageCallback", org.apache.thrift.protocol.TMessageType.ONEWAY, 0));
        messageCallback_args args = new messageCallback_args();
        args.setName(name);
        args.setStatus(status);
        args.write(prot);
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    private static <I extends Iface> java.util.Map<String,  org.apache.thrift.ProcessFunction<I, ? extends org.apache.thrift.TBase>> getProcessMap(java.util.Map<String, org.apache.thrift.ProcessFunction<I, ? extends  org.apache.thrift.TBase>> processMap) {
      ...
      processMap.put("messageCallback", new messageCallback());
      return processMap;
    }
    ...
    public static class messageCallback<I extends Iface> extends org.apache.thrift.ProcessFunction<I, messageCallback_args> {
      public messageCallback() {
        super("messageCallback");
      }

      public messageCallback_args getEmptyArgsInstance() {
        return new messageCallback_args();
      }
      ...
      public org.apache.thrift.TBase getResult(I iface, messageCallback_args args) throws org.apache.thrift.TException {
        iface.messageCallback(args.name, args.status);
        return null;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class messageCallback<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, messageCallback_args, Void> {
      public messageCallback() {
        super("messageCallback");
      }
      ...
      public void start(I iface, messageCallback_args args, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException {
        iface.messageCallback(args.name, args.status,resultHandler);
      }
    }
  ...
  public static class messageCallback_args implements org.apache.thrift.TBase<messageCallback_args, messageCallback_args._Fields>, java.io.Serializable, Cloneable, Comparable<messageCallback_args>   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("messageCallback_args");

    private static final org.apache.thrift.protocol.TField NAME_FIELD_DESC = new org.apache.thrift.protocol.TField("name", org.apache.thrift.protocol.TType.STRING, (short)1);
    private static final org.apache.thrift.protocol.TField STATUS_FIELD_DESC = new org.apache.thrift.protocol.TField("status", org.apache.thrift.protocol.TType.I32, (short)2);

    private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new messageCallback_argsStandardSchemeFactory();
    private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new messageCallback_argsTupleSchemeFactory();
    ...
    static {
      ...
      metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(messageCallback_args.class, metaDataMap);
    }

    public messageCallback_args() {
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public messageCallback_args(messageCallback_args other) {
    ...
    public messageCallback_args deepCopy() {
      return new messageCallback_args(this);
    }
    ...
    public messageCallback_args setName(@org.apache.thrift.annotation.Nullable String name) {
      this.name = name;
      return this;
    }
    ...
    public messageCallback_args setStatus(int status) {
      this.status = status;
      setStatusIsSet(true);
      return this;
    }
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof messageCallback_args)
        return this.equals((messageCallback_args)that);
      return false;
    }

    public boolean equals(messageCallback_args that) {
      if (that == null)
        return false;
      if (this == that)
        return true;
    ...
    @Override
    public int compareTo(messageCallback_args other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("messageCallback_args(");
      boolean first = true;
    ...
    private static class messageCallback_argsStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
      public messageCallback_argsStandardScheme getScheme() {
        return new messageCallback_argsStandardScheme();
      }
    }

    private static class messageCallback_argsStandardScheme extends org.apache.thrift.scheme.StandardScheme<messageCallback_args> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, messageCallback_args struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, messageCallback_args struct) throws org.apache.thrift.TException {
        struct.validate();
    ...
    private static class messageCallback_argsTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
      public messageCallback_argsTupleScheme getScheme() {
        return new messageCallback_argsTupleScheme();
      }
    }

    private static class messageCallback_argsTupleScheme extends org.apache.thrift.scheme.TupleScheme<messageCallback_args> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, messageCallback_args struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
        java.util.BitSet optionals = new java.util.BitSet();
        if (struct.isSetName()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, messageCallback_args struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TTupleProtocol iprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
